...
auto_switch_gh_account() {
  case "$PWD" in
    $HOME/Projects/dotfiles|$HOME/Projects/dotfiles/*)
      gh auth switch -h github.com -u BostonRohan >/dev/null 2>&1
      ;;
    $HOME/Projects/Personal|$HOME/Projects/Personal/*)
      gh auth switch -h github.com -u BostonRohan >/dev/null 2>&1
      ;;
    $HOME/Projects/Work|$HOME/Projects/Work/*)
      gh auth switch -h github.com -u ec-boston >/dev/null 2>&1
      ;;
  esac
}

add-zsh-hook chpwd auto_switch_gh_account
auto_switch_gh_account
